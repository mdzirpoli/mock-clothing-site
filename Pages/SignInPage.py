...
class SignInPage(BasePage):
    ...
    def click_sign_in_menu_button(self):
        self.driver.find_element(*SignInPage.SIGN_IN_MENU_BUTTON).click()

    def input_create_account_email_address_textbox(self, email):
        self.driver.find_element(*SignInPage.CREATE_ACCOUNT_EMAIL_ADDRESS_TEXTBOX).send_keys(email)

    def click_create_an_account_button(self):
        self.driver.find_element(*SignInPage.CREATE_AN_ACCOUNT_BUTTON).click()

    def input_email_address_textbox(self, email):
        self.driver.find_element(*SignInPage.EMAIL_ADDRESS_TEXTBOX).send_keys(email)

    def input_password_textbox(self, password):
        self.driver.find_element(*SignInPage.PASSWORD_TEXTBOX).send_keys(password)

    def click_sign_in_button(self):
        self.driver.find_element(*SignInPage.SIGN_IN_BUTTON).click()

    def click_forgot_your_password_link(self):
        self.driver.find_element(*SignInPage.FORGOT_YOUR_PASSWORD_LINK).click()
